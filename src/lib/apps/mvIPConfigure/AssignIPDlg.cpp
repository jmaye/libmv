...
//-----------------------------------------------------------------------------
{
    ...
    */
    ...
    {
        wxBoxSizer* pNoticeBoxSizer = new wxStaticBoxSizer( wxVERTICAL, pPanel, wxT( "Notice:" ) );
        pNoticeBoxSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "This machine cannot communicate with the camera, because the camera is on a different subnet.\nPlease assign to the camera a temporary IP in the same subnet to restore communication." ) ), wxSizerFlags().Left().Center() );
        pTopDownSizer->Add( pNoticeBoxSizer, wxSizerFlags().Expand() );
        pTopDownSizer->AddSpacer( 10 );
    }
    ...
    // row 2
    pEditElementsGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "Temporary IP Address:" ) ), wxSizerFlags().Left().Center() );
    ...
    // row 3
    pEditElementsGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "Temporary Subnet Mask:" ) ), wxSizerFlags().Left().Center() );
    ...
    // row 4
    pEditElementsGridSizer->Add( new wxStaticText( pPanel, wxID_ANY, wxT( "Temporary Gateway:" ) ), wxSizerFlags().Left().Center() );
