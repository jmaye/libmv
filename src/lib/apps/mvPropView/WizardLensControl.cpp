...
WizardLensControl::WizardLensControl( wxWindow* pParent, const wxString& title, mvIMPACT::acquire::Device* pDev )
    : OkAndCancelDlg( pParent, widMainFrame, title, wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxMINIMIZE_BOX ),
      ...
      pSTIrisMode_( 0 ), pCBIrisMode_( 0 ), pSTDriveLevel_( 0 ), pSCDriveLevel_( 0 ),
...
//-----------------------------------------------------------------------------
{
    ...
    */
    ...
    wxBoxSizer* pLensControlSettingsSizer = 0;
    wxString mvIrisMode;
    ...
    wxFlexGridSizer* pLensControlSettingsGridSizer = new wxFlexGridSizer( 2, 0 );
    pLensControlSettingsGridSizer->AddGrowableCol( 1, 3 );
    pLensControlSettingsGridSizer->Add( pSTIrisMode_ );
    pLensControlSettingsGridSizer->Add( pCBIrisMode_, wxSizerFlags( 3 ).Expand() );
    pLensControlSettingsGridSizer->Add( pSTDriveLevel_ );
    pLensControlSettingsGridSizer->Add( pSCDriveLevel_, wxSizerFlags( 3 ).Expand() );

    pLensControlSettingsSizer = new wxStaticBoxSizer( wxVERTICAL, pPanel, wxT( "Settings: " ) );
    pLensControlSettingsSizer->AddSpacer( 5 );
    pLensControlSettingsSizer->Add( pLensControlSettingsGridSizer, wxSizerFlags().Expand() );
    pLensControlSettingsSizer->AddSpacer( 5 );
    ...
    pTopDownSizer->Add( pLensControlSettingsSizer, wxSizerFlags().Expand() );
    pTopDownSizer->AddSpacer( 10 );
